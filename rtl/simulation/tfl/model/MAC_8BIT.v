...
.A  ({{2{MAC_OPER_DATA[7]}},MAC_OPER_DATA[7:0]}), 
.B  ({{2{MAC_COEF_DATA[7]}},MAC_COEF_DATA[7:0]}), 
...
always@(*) begin : ACC_ROUNDED
  case(MAC_OUT_SEL[5:0])
    ...
    6'd6  : is_rounded_value = 20'b0000_0000_0000_0010_0000;
    6'd7  : is_rounded_value = 20'b0000_0000_0000_0100_0000;
...
always@(*) begin : CHECK_SAT_CONDITION
  case(fMAC_OUT_SEL[5:0])
  6'd0  : is_not_saturation = &fmux_acc_idata[19:7]  || !(|fmux_acc_idata[19:7]) ;
  6'd1  : is_not_saturation = &fmux_acc_idata[19:8]  || !(|fmux_acc_idata[19:8]) ;
  6'd2  : is_not_saturation = &fmux_acc_idata[19:9]  || !(|fmux_acc_idata[19:9]) ;
  6'd3  : is_not_saturation = &fmux_acc_idata[19:10] || !(|fmux_acc_idata[19:10]) ;
  6'd4  : is_not_saturation = &fmux_acc_idata[19:11] || !(|fmux_acc_idata[19:11]) ;
  6'd5  : is_not_saturation = &fmux_acc_idata[19:12] || !(|fmux_acc_idata[19:12]) ;
  6'd6  : is_not_saturation = &fmux_acc_idata[19:13] || !(|fmux_acc_idata[19:13]) ;
  6'd7  : is_not_saturation = &fmux_acc_idata[19:14] || !(|fmux_acc_idata[19:14]) ;
  6'd8  : is_not_saturation = &fmux_acc_idata[19:15] || !(|fmux_acc_idata[19:15]) ;
  6'd9  : is_not_saturation = &fmux_acc_idata[19:16] || !(|fmux_acc_idata[19:16]) ;
  6'd10 : is_not_saturation = &fmux_acc_idata[19:17] || !(|fmux_acc_idata[19:17]) ;
  6'd11 : is_not_saturation = &fmux_acc_idata[19:18] || !(|fmux_acc_idata[19:18]) ;
